...
%%% This m file contains the script to recreate Figure 2a in the paper.
%%% The script reads reconstructed data from the ../data_output/ folder and
%%% puts the tif image in the  ../Figures folder.
%%% FIGURE 2a :  No Shim and Dynamic Shim coronal fieldmaps for subject 1
...
outfile = sprintf('%s/../figures/Figure_2a.tif', code_path);
