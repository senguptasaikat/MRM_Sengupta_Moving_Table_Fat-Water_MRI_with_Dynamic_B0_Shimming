...
%%% This m file contains the script to recreate Figure 2c in the paper.
%%% The script reads reconstructed data from the ../data_output/ folder and
%%% puts the tif image in the  ../Figures folder.
%%% FIGURE 2c :  No Shim and Dynamic Shim sagittal fieldmaps for subject 1
...
mat_file{1} = 'Sub1_NS_outParamsQPBO_PYTHON';
mat_file{2} = 'Sub1_DS_outParamsQPBO_PYTHON';
...
figure; imagesc(-A_Final,[ -250 250]); axis image off; colormap(jet); colorbar;
F = getframe;

outfile = sprintf('%s/../figures/Figure_2c.tif', code_path);
