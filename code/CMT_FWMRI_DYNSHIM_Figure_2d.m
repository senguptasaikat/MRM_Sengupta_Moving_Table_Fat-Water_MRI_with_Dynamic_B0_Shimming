...
%%% This m file contains the script to recreate Figure 2d in the paper.
%%% The script reads reconstructed data from the ../data_output/ folder and
%%% puts the tif image in the  ../Figures folder.
%%% FIGURE 2d :  No Shim and Dynamic Shim coronal fieldmaps for Subject 2
...
outfile = sprintf('%s/../figures/Figure_2d.tif', code_path);
